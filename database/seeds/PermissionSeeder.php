...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /* Post Module Permission */
        $modulePost = Module::updateOrCreate(['name' => 'Blog Category']);
        Permission::updateOrCreate([
            'module_id' => $modulePost->id,
            'name' => 'Show',
            'slug' => 'blog_category_index',
        ]);
        Permission::updateOrCreate([
            'module_id' => $modulePost->id,
            'name' => 'Create',
            'slug' => 'blog_category_create',
        ]);
        Permission::updateOrCreate([
            'module_id' => $modulePost->id,
            'name' => 'Edit',
            'slug' => 'blog_category_edit',
        ]);
        Permission::updateOrCreate([
            'module_id' => $modulePost->id,
            'name' => 'Delete',
            'slug' => 'blog_category_destroy',
        ]);
        ...
        $staticPageModule = Module::updateOrCreate(['name' => 'Static Page Management']);
        Permission::updateOrCreate([
            'module_id' => $staticPageModule->id,
            'name' => 'Access Page',
            'slug' => 'page_index',
        ]);
        Permission::updateOrCreate([
