                            ...
                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('myorder.show',base64_encode($order->id)) }}" class="btn btn-sm btn-info">Details</a>
                                            <a href="{{ route('track',[auth()->user()->slug,base64_encode($order->id)]) }}" class="btn btn-sm btn-success">Track</a>
                                        </td>
                                    </tr>
                                @endforeach
