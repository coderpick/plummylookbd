...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <br>
            <H2 class="text-center">Merchant Registration</H2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('vendor.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('National ID No.') }} <span class="text-danger">*</span></label>

                            <div class="col-md-6">
                                <input id="nid" type="number" class="form-control @error('nid') is-invalid @enderror" name="nid" value="{{ old('nid') }}" required autocomplete="nid">
