    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row" action="{{ route('brand.update',$brand->slug) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-group col-md-8">
                            <label class="control-label">Brand Name</label>
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ isset($brand)?$brand->name:null }}" placeholder="Enter brand name">
                            @error('name')
