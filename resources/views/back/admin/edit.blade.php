                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ $user->name??old('name') }}" >
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" value="{{ $user->email??old('email') }}"  class="form-control @error('email') is-invalid @enderror" id="email" >
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="phone" type="text" value="{{ $user->phone??old('phone') }}"  class="form-control @error('phone') is-invalid @enderror" id="phone">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="number" min="0" name="nid" id="nid" value="{{ $user->nid??old('nid') }}">
                                    @error('nid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="input-file-max-fs" class="dropify @error('image') is-invalid @enderror" data-default-file="{{ isset($user)?asset($user->image):null }}" data-max-file-size="2M">
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="toggle lg">
                            <label>
                                <input type="checkbox" name="status" {{ $user->status == true?'checked':'' }}><span class="button-indecator"></span>
                            </label>
                        </div>
                    </div>
                </div>
