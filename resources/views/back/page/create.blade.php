                ...
                <div class="tile-body">
                    <form action="{{ route('page.store') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="slug" value="{{ old('slug') }}" name="slug">
                                    @error('slug')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="toggle lg">
                                <label>
                                    <input type="checkbox" name="status"><span class="button-indecator"></span>
                                </label>
                            </div>
                        </div>
                        <div class="tile-footer">
                            <button class="btn btn-primary" type="submit">
                                <i class="fa fa-save me-2"></i> Create</button>
                        </div>
                    </form>
