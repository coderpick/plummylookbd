...
<meta property="og:title" content="{{ucfirst($title??'')}} @if(isset($title))-@endif @if(isset($meta) && $meta->title == !null) {{ucfirst($meta->title)}}@endif">
<meta property="og:description" content="@if(isset($meta_description) && $meta_description == !null) {{ $meta_description }}
@elseif(isset($description) && $description == !null) {{ $description }}
@elseif(isset($meta) && $meta->description == !null) {{ $meta->description }}
@else ' ' @endif">
<meta property="og:type" content="website">
<meta property="og:url" content="{{ url()->current() }}">
<meta property="og:image" content="{{ asset((isset($link) && $link->logo != null)? $link->logo : 'uploads/default_logo.png') }}">
<!-- Twitter Card Meta Tags for Twitter Sharing -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="{{ucfirst($title??'')}} @if(isset($title))-@endif @if(isset($meta) && $meta->title == !null) {{ucfirst($meta->title)}}@endif">
<meta name="twitter:description" content="@if(isset($meta_description) && $meta_description == !null) {{ $meta_description }}
@elseif(isset($description) && $description == !null) {{ $description }}
@elseif(isset($meta) && $meta->description == !null) {{ $meta->description }}
@else ' ' @endif">
