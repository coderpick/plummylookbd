...
<ul class="app-menu">
    ...
    @can('app.order.index')
        <li class="treeview {{ Request::is('secure/orders*') || Request::is('secure/pathao/send*')?'is-expanded':'' }}"><a class="app-menu__item {{ Request::is('secure/orders*')?'active':'' }}" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-hand-pointer-o"></i><span class="app-menu__label">Orders</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item {{ Request::is('secure/orders/processing') || Request::is('secure/pathao/send*')?'active':'' }}" href="{{ route('orders.processing') }}"><i class="icon fa fa-circle-o"></i><span class="app-menu__label">Processing</span></a></li>
